 ...
 */
public class ScheduleSuperviseMsgEventImpl extends BaseMailEvent implements EventHandler {
    ...
    public void handleEvent(Event event) {
        ...
        MessageBean messageBean = createMessageBean(head, content, MSG_TITLE);
        dao.save(messageBean);
        //add msg to stack
        Gson gson = new Gson();
        stackService.publish(String.format(Const.POLLING_MESSAGE_TOPIC_FORMAT, String.valueOf(head)), gson.toJson(messageBean), day);
    }
}
